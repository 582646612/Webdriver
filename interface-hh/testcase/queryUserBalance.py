...
queryUserBalance_xls = common.get_xls("userCase.xlsx", "queryUserBalance")
localReadConfig = readConfig.ReadConfig()
configHttp = ConfigHttp.ConfigHttp()
info = {}

@paramunittest.parametrized(*queryUserBalance_xls)

class queryUserBalance(unittest.TestCase):
    def setParameters(self,case_name,method,token,phoneNumber,status,msg):
    ...
    def testqueryUserBalance(self):
        # set url
        self.url = common.get_url_from_xml('queryUserBalance')
